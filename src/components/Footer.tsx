...
import img from "../../public/foot.png";



const Footer = () => {
  return (
    <footer className="relative bg-blackkk">
      ...
      <div className="mx-auto w-full max-w-screen-xl ">
        ...
        <div className="absolute z-10 bottom-0 right-0 xl:w-[50rem] md:w-[25rem]">
      <Image src={img} alt="background image" className="w-full object-cover"/>
      </div>
      </div>
        <div className=" px-2 py-4 bg-[#4f4f4fb6] w-full  md:flex md:items-center md:justify-between relative z-10">
          <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center ml-20">
          Copyright © 2024 by Taha. All Rights Reserved.
          </span>

          <div className="flex justify-center gap-[14px] mr-20">
            <div className="bg-white w-[30px] h-[28px] flex justify-center items-center rounded"><a href=""><FaFacebookF /></a></div>
            <div className="bg-white w-[30px] h-[28px] flex justify-center items-center rounded"><FaTwitter /></div>
            <div className="bg-white w-[30px] h-[28px] flex justify-center items-center rounded"><a href="">< FaInstagram /></a></div>
            <div className="bg-white w-[30px] h-[28px] flex justify-center items-center rounded text-[#FF9F0D]"><FaYoutube /></div>
            <div className="bg-white w-[30px] h-[28px] flex justify-center items-center rounded"><FaPinterest /></div>
          </div>
